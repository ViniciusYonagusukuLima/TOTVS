...
class class_sxs
    ...
    //SX1 ? Campos
    //SX2 ? Estruturas de tabelas
    //SX3 ? Campos adicionais
    //SX7 ? Tabelas de validação
    //SIX ? Índices
    //SXB ? Botões adicionais da tela
...
method upd_sxs(cTabela,lShowMsg) class class_sxs
    ...
    IF empty(cTabela)
        ...
        // Pelo motivo de declarar ele .F. acima, não é necessário colocar == .T. no lShowMsg.
        IF lShowMsg
